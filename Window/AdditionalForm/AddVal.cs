    ...
    public partial class AddVal : Form
    {
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                MessBox.MessBox.Show("Zapis", "Wycena numer " + newValuation.IdVal.ToString() + "\n" +
                    "Nazwa:" + newValuation.NameVal + "\n" +
                    "Cena" + newValuation.ValTotalAmount + "\n" +
                    "Ilość produktów" + newValuation.Products.Count(), MessBox.TypeOfBox.Ok, MessBox.Icons.Ok);
        ...
        private Models.Valuations CreateNewValuation()
        {
            ...
            foreach (DataGridViewRow row in dataGridView1.Rows)
            {
                ...
                //string dotPrice = row.Cells[3].Value.ToString().Replace(',', '.');
                prod.DefaultPrice = float.Parse(row.Cells[3].Value.ToString().Replace(',', '.'));
                prod.DefaultQuantity = int.Parse(row.Cells[4].Value.ToString());
                listProducts.Add(prod);
            }
            newValuation.Products = listProducts;
        ...
        private void addData()
        {
            ...
            dataGridView1.Rows[rowIndex].Cells[5].Value = prod.DefaultPrice * prod.DefaultQuantity;
            dataGridView2.Rows.Clear();
        ...
        private void SetPrice()
        {
            ...
            foreach (var row in dataRows)
            {
                ...
                row.Cells[5].Value = double.Parse(row.Cells[3].Value.ToString()) * double.Parse(row.Cells[4].Value.ToString());
            }
