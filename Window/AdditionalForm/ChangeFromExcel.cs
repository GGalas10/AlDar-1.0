...
namespace AlDar_1._0.Window.AdditionalForm
{
    public partial class ChangeFromExcel : Form
    {
        ...
        List<BaseProducts> productListToChange = new List<BaseProducts>();
        ...
        private void AddRows(DataGridView dataView, BaseProducts prod)
        {
            dataView.Rows.Add();
        ...
        public void AddRowsChange(DataGridView dataview,BaseProducts one, BaseProducts two)
        {
            DataGridViewCellStyle cell = new DataGridViewCellStyle();
